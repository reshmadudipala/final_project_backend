...
function getRecordDetails() {
  var userID = currentUserLoginID
      ...
      fetch(`http://138.197.127.91:3000/api/getRecordDetails?userID=${userID}&forWhat=${forWhat}`)
...
function saveRecord() {
      ...
      // Replace 'http://localhost:3000' with your actual server URL
      fetch('http://138.197.127.91:3000/api/saveRecord', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
...
function deleteRecord() {
      ...
      // Replace 'http://localhost:3000' with your actual server URL
      fetch(`http://138.197.127.91:3000/api/deleteRecord?userID=${userID}&forWhat=${forWhat}`, {
        method: 'DELETE',
      })
      .then(response => response.json())
      .then(data => {
